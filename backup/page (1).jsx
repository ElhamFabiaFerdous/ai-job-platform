...
export default function ProfilePage() {
  ...
  useEffect(() => {
    // LocalStorage থেকে user data নাও
    ...
    // API থেকে সর্বশেষ profile data আনো
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <button
            ...
            className="bg-white/10 hover:bg-white/20 border border-white/20 text-white py-3 rounded-xl transition text-sm"
          >
            📊 ড্যাশবোর্ড
          </button>
          <button
